...
const Radar = function (size, radar) {
  ...
  function plotRadarHeader() {
    ...
    header.select('.radar-title')
      ...
      .html('<a href="http://wa-sierratechradar.azurewebsites.net/"> <img src="/images/logo.png" /> </a>');
  ...
  function plotRadarFooter() {
    d3.select('body')
      ...
      .append('p')
      .html('Powered by <a href="https://github.com/thoughtworks/build-your-own-radar "> Open Source</a>. ');
  }
